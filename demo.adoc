...
- https://sdkman.io/[SDKMAN] (for Java 19 with GraalVM)
...
Use SDKMAN to install Java 19 with GraalVM
...
+
----
Micronaut: (27 + 40 + 28 + 25 + 35) / 5 = 31
Quarkus: (24 + 20 + 20 + 26 + 27) / 5 = 23.4
Spring Boot: (43 + 43 + 41 + 41 + 40) / 5 = 41.6
Helidon: (39 + 50 + 36 + 47 + 47) / 5 = 43.8
----
...
|Micronaut | `./micronaut/build/native/nativeCompile/app` | 31
|Quarkus | `./quarkus/build/quarkus-1.0.0-SNAPSHOT-runner` | 23.4
|Spring Boot | `./spring-boot/build/native/nativeCompile/spring-boot` | 41.6
...
|Micronaut | `app` | 40 | 54 | 57
|Quarkus | `quarkus` | 35 | 48 | 50
|Spring Boot | `spring-boot` | 69 | 81 | 82
|Helidon | `helidon` | 74 | 93 | 126
|===

IMPORTANT: If you disagree with these numbers and think X framework should be faster, I encourage you to clone https://github.com/oktadev/auth0-java-rest-api-examples[this repo] and run these tests yourself. If you get faster startup times for Spring Boot, do you get faster startup times for Micronaut and Quarkus too?
